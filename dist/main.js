...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.not-completed {
    text-decoration: line-through;
}
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,6BAA6B;AACjC","sourcesContent":[".not-completed {\n    text-decoration: line-through;\n}\n"],"sourceRoot":""}]);
// Exports
...
function displayList() {
    ...
    for (let i = 0; i < _newItem_service__WEBPACK_IMPORTED_MODULE_0__.parentList.length; i++) {
        const item = _newItem_service__WEBPACK_IMPORTED_MODULE_0__.parentList[i];
