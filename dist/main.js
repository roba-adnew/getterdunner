...
function buildListHtmlElements() {
    ...
    for (let i = 0; i < _newItem_service__WEBPACK_IMPORTED_MODULE_0__.parentList.length; i++){
        ...
        checkBox.id = _newItem_service__WEBPACK_IMPORTED_MODULE_0__.parentList[i]['uuid'];
...
//   .forEach((element) => element.style.size = "100px");
    ...
    Array.from(checkBoxes).forEach((checkBox) => {
        checkBox.addEventListener('click', () => {
            ...
            _newItem_service__WEBPACK_IMPORTED_MODULE_0__.parentList[checkBox.id][`isCompleted`];
        
            if (!_newItem_service__WEBPACK_IMPORTED_MODULE_0__.parentList[checkBox.id][`isCompleted`]) {
                _newItem_service__WEBPACK_IMPORTED_MODULE_0__.parentList[checkBox.id]['isCompleted'] = true;
                itemRow.className = 'completed';
            }   
            else {
                _newItem_service__WEBPACK_IMPORTED_MODULE_0__.parentList[checkBox.id]['isCompleted'] = false;
                itemRow.className = 'not-completed';  
            };
...
function newTodo(todo, details, tags, dueDate) {    
    ...
    return { isCompleted, uuid, todo, details, tags, dueDate }
} 
