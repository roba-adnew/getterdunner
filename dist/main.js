...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,6BAA6B;AACjC","sourcesContent":[".completed {\n    text-decoration: line-through;\n}\n"],"sourceRoot":""}]);
// Exports
...
/******/ 	function __nested_webpack_require_12654__(moduleId) {
...
/******/ 		__webpack_modules__[moduleId].call(module.exports, module, module.exports, __nested_webpack_require_12654__);
/******/ 	
...
/******/ 		__nested_webpack_require_12654__.n = function(module) {
/******/ 			var getter = module && module.__esModule ?
/******/ 				function() { return module['default']; } :
/******/ 				function() { return module; };
/******/ 			__nested_webpack_require_12654__.d(getter, { a: getter });
/******/ 			return getter;
/******/ 		};
/******/ 	}();
/******/ 	
...
/******/ 		__nested_webpack_require_12654__.d = function(exports, definition) {
/******/ 			for(var key in definition) {
/******/ 				if(__nested_webpack_require_12654__.o(definition, key) && !__nested_webpack_require_12654__.o(exports, key)) {
...
/******/ 	!function() {
/******/ 		__nested_webpack_require_12654__.o = function(obj, prop) { return Object.prototype.hasOwnProperty.call(obj, prop); }
/******/ 	}();
/******/ 	
/************************************************************************/
...
// EXPORTS
__nested_webpack_require_12654__.d(__nested_webpack_exports__, {
...
var sha512 = __nested_webpack_require_12654__(195);
var sha512_default = /*#__PURE__*/__nested_webpack_require_12654__.n(sha512);
...
/* harmony export */   setupCheckListeners: () => (/* binding */ setupCheckListeners)
/* harmony export */ });
...
function buildListHtmlElements() {
    ...
    for (let i = 0; i < _newItem_service__WEBPACK_IMPORTED_MODULE_0__.parentList.length; i++){
        ...
        checkBox.id = _newItem_service__WEBPACK_IMPORTED_MODULE_0__.parentList[i]['todoID'];
        if(_newItem_service__WEBPACK_IMPORTED_MODULE_0__.parentList[i][`isCompleted`]) {
        ...
        const itemExample = (0,_newItem_service__WEBPACK_IMPORTED_MODULE_0__.newTodo)();
        for (let key in itemExample) {
            if (key == 'isCompleted' || key == 'todoID')  continue; 
            const itemDisplay = document.createElement('td');
            itemDisplay.innerHTML = _newItem_service__WEBPACK_IMPORTED_MODULE_0__.parentList[i][key]; 
...
//   .forEach((element) => element.style.size = "100px");
    ...
    Array.from(checkBoxes).forEach((checkBox) => {
        checkBox.addEventListener('click', (event) => {
            ...
            const index = _newItem_service__WEBPACK_IMPORTED_MODULE_0__.parentList.findIndex(
                todo =>  todo.todoID == checkBox.id);            
            const itemRow = checkBox.parentElement.parentElement;
            
            if (!_newItem_service__WEBPACK_IMPORTED_MODULE_0__.parentList[index]['isCompleted']) {
                _newItem_service__WEBPACK_IMPORTED_MODULE_0__.parentList[index]['isCompleted'] = true;
                itemRow.className = 'completed';
            }   
            else {
                _newItem_service__WEBPACK_IMPORTED_MODULE_0__.parentList[index]['isCompleted'] = false;
                itemRow.className = 'not-completed';  
            };

            console.table(_newItem_service__WEBPACK_IMPORTED_MODULE_0__.parentList);
        
            (0,_newItem_service__WEBPACK_IMPORTED_MODULE_0__.organizeParentList)();
        })
    });   
}
...
/* harmony export */ });
/* harmony import */ var _newItem_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./newItem.service */ "./src/newItem.service.js");
/* harmony import */ var jsuites__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! jsuites */ "./node_modules/jsuites/dist/jsuites.js");
/* harmony import */ var jsuites__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(jsuites__WEBPACK_IMPORTED_MODULE_1__);
...
function createNewItemForm () {
    ...
    for (let key in itemExample) {
        ...
        if (key == 'dueDate') {
            ...
            newItemField.id = key;    
            jsuites__WEBPACK_IMPORTED_MODULE_1__.jSuites.calendar(newItemField,{format: 'DD/MM/YYYY'});
            newItemForm.appendChild(newItemField);
            continue;
        };

        const newItemField = document.createElement(`input`);
        newItemField.id, newItemField.placeholder = key;        
...
// export function enableDueDate(dueDateElement) {

    // dueDateElement.removeAttribute('placeholder');
    // dueDateElement.removeAttribute('style');
    
    // dueDateElement.addEventListener('onchange', function(e) {
    //     console.log('New value: ' + e.target.value)
    // });
    // dueDateElement.addEventListener('onclose', function(e) {
...
function addNewItem() {
    ...
    const newItem = (0,_newItem_service__WEBPACK_IMPORTED_MODULE_0__.newTodo)(
    ...
    _newItem_service__WEBPACK_IMPORTED_MODULE_0__.parentList.push(newItem);
}
...
function newTodo(todo, details, tags, dueDate) {    
    let isCompleted = false;
    let todoID = (0,uuid__WEBPACK_IMPORTED_MODULE_0__["default"])();
...
/* harmony import */ var _newItem_service_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./newItem.service.js */ "./src/newItem.service.js");
/* harmony import */ var _listDisplay_service_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./listDisplay.service.js */ "./src/listDisplay.service.js");
...
(0,_listDisplay_service_js__WEBPACK_IMPORTED_MODULE_2__.buildListHtmlElements)();
(0,_listDisplay_service_js__WEBPACK_IMPORTED_MODULE_2__.setupCheckListeners)();
...
submitButton.addEventListener('click', function(event) {
    ...
    (0,_listDisplay_service_js__WEBPACK_IMPORTED_MODULE_2__.clearList)();

    (0,_newItem_service_js__WEBPACK_IMPORTED_MODULE_1__.organizeParentList)();
    (0,_listDisplay_service_js__WEBPACK_IMPORTED_MODULE_2__.buildListHtmlElements)();
    (0,_listDisplay_service_js__WEBPACK_IMPORTED_MODULE_2__.setupCheckListeners)();
    
    console.table(_newItem_service_js__WEBPACK_IMPORTED_MODULE_1__.parentList)
})
